...
- **Azure SQL**: Requer `azureADOnlyAuthentication = true` (política MCAPS). O script automaticamente configura isso via `01b-configure-entra-auth.ps1`.
- Todos os serviços usam o **mesmo dataset e embeddings** para comparação justa

## Problemas Conhecidos e Soluções

### Azure SQL: Erro `RequestDisallowedByPolicy`
**Causa**: Política MCAPS exige Entra AD-only authentication.  
